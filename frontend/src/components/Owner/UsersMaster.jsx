            ...
            {loading ? (
              ...
              filteredUsers.map(u => (
                <tr key={u.id} className="border-b hover:bg-slate-50">
                  ...
                  <td className="p-3">
                    <span className={`px-2 py-1 text-xs rounded-full ${u.role === 'OWNER' ? 'bg-purple-100 text-purple-700' : u.role === 'STORE_KEEPER' ? 'bg-orange-100 text-orange-700' : 'bg-blue-100 text-blue-700'}`}>
                      {u.role}
                    </span>
                  </td>
                  <td className="p-3">
                  ...
                  <td className="p-3">
                    <div className="flex gap-2">
                      ...
                      <button onClick={() => toggleStatus(u)} className={`text-sm hover:underline ${u.status === 'Active' ? 'text-red-600' : 'text-green-600'}`}>
